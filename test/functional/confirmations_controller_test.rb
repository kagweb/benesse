...
class ConfirmationsControllerTest < ActionController::TestCase
  ...
  test "should create confirmation" do
    assert_difference('Confirmation.count') do
      post :create, confirmation: { project_id: @confirmation.project_id, status: @confirmation.status, type: @confirmation.type, user_id: @confirmation.user_id }
    end
  ...
  test "should update confirmation" do
    put :update, id: @confirmation, confirmation: { project_id: @confirmation.project_id, status: @confirmation.status, type: @confirmation.type, user_id: @confirmation.user_id }
    assert_redirected_to confirmation_path(assigns(:confirmation))
  end
